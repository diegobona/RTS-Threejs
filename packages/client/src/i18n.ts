...
export const UI_TEXT = {
  zh: {
    ...
    hud: {
      ...
      missileAmmo: (fired: number, total: number) => `导弹已发射 ${fired}/${total}`,
    ...
    buildMeta: {
      ...
      barracks: { icon: '▥', label: '兵营', hint: '可生产：soldier' },
      warfactory: { icon: '▰', label: '战车工厂', hint: '可生产：tank、missile truck' },
      airbase: { icon: '✈', label: '空军基地', hint: '可生产：fighter' },
      ...
      arty: { icon: '⊕', label: '导弹车', hint: '远程对地打击' },
  ...
  en: {
    ...
    hud: {
      ...
      missileAmmo: (fired: number, total: number) => `Missiles fired ${fired}/${total}`,
    ...
    buildMeta: {
      ...
      barracks: { icon: '▥', label: 'Barracks', hint: 'Produces: soldier' },
      warfactory: { icon: '▰', label: 'War Factory', hint: 'Produces: tank, missile truck' },
      airbase: { icon: '✈', label: 'Airbase', hint: 'Produces: fighter' },
      ...
      arty: { icon: '⊕', label: 'Missile Truck', hint: 'Long-range ground strike' },
