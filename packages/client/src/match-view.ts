...
import { buildArt, loadWw1BuildingArt, loadWw1UnitArt, makeCameo } from './placeholder-art';
...
.mv-cameo canvas, .mv-cameo img { display: block; width: 100%; }
...
export class MatchView {
  ...
  async init(): Promise<void> {
    ...
    const ww1Buildings = await loadWw1BuildingArt();
    const ww1Units = await loadWw1UnitArt();
    const art = buildArt(this.app, this.world.rules.units.values(), ww1Buildings, ww1Units);
